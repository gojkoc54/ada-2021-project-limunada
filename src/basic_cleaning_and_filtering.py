...
Original file is located at
    https://colab.research.google.com/drive/1zviDUyiSp3iCmiux8WwRHnWj8QokWOXz

# Notebook with initial cleaning and filtering the data
...
for year in range(2015, 2021):
  ...
  with bz2.open(path_to_file, 'rb') as s_file:
    for instance in s_file:
      ...
      # we suppose that first qid is the correct one
      speaker_qid = instance['qids'][0]
